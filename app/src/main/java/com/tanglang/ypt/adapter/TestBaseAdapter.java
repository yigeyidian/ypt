...
public class TestBaseAdapter extends BaseAdapter implements
    ...
    public TestBaseAdapter(Context context) {
        ...
        mCountries = context.getResources().getStringArray(R.array.drugs);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String drug = mCountries[position];
        holder.text.setText(drug.substring(1, drug.length()));
    ...
    public int getPositionForIndex(String index) {
        for (int i = 0; i < mSectionIndices.length; i++) {
            if (mCountries[mSectionIndices[i]].substring(0, 1).equals(index)) {
    ...
    public void restore() {
        mCountries = mContext.getResources().getStringArray(R.array.drugs);
        mSectionIndices = getSectionIndices();
        mSectionLetters = getSectionLetters();
        notifyDataSetChanged();
    }
